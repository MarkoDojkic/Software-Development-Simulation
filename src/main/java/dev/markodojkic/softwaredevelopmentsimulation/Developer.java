...
public class Developer {
	...
	public TechnicalTask trivialTaskHandler(TechnicalTask technicalTask) {
		...
		Utilities.getIPrinter().sendToJiraActivityStream(String.format("\033[1m%s\033[21m\033[24m created \033[3m\033[1mTASK-%s\033[21m\033[24m - %s\033[23m ◴ %s$",
				technicalTask.getReporter().getDisplayName(), Math.abs(technicalTask.getId().hashCode()), technicalTask.getName(), technicalTask.getCreatedOn().plusSeconds(artificialOffsetSeconds).format(DateTimeFormatter.ofPattern("dd.MM.yyyy HH:mm:ss"))).concat(String.format("\033[1m%s\033[21m\033[24m changed the Assignee to '\033[1m%s\033[21m\033[24m' on \033[3m\033[1mTASK-%s\033[21m\033[24m - %s\033[23m ◴ %s$",
		...
		Utilities.getIPrinter().sendToJiraActivityStream(String.format("\033[1m%s\033[21m\033[24m changed the status to In progress on \033[3m\033[1mTASK-%s\033[21m\033[24m - %s\033[23m ◴ %s$",
