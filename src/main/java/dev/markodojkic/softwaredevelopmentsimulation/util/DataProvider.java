...
public class DataProvider {
	public static final List<User> developers = List.of(
			new User((random.nextInt(100) % 100 < 45 ? lorem.getNameFemale() : lorem.getNameMale()), generateRandomJMBG(), UserType.values()[random.nextInt(UserType.values().length)], random.nextLong(1, 18)),
			new User((random.nextInt(100) % 100 < 45 ? lorem.getNameFemale() : lorem.getNameMale()), generateRandomJMBG(), UserType.values()[random.nextInt(UserType.values().length)], random.nextLong(1, 18)),
			new User((random.nextInt(100) % 100 < 45 ? lorem.getNameFemale() : lorem.getNameMale()), generateRandomJMBG(), UserType.values()[random.nextInt(UserType.values().length)], random.nextLong(1, 18)),
			new User((random.nextInt(100) % 100 < 45 ? lorem.getNameFemale() : lorem.getNameMale()), generateRandomJMBG(), UserType.values()[random.nextInt(UserType.values().length)], random.nextLong(1, 18)),
			new User((random.nextInt(100) % 100 < 45 ? lorem.getNameFemale() : lorem.getNameMale()), generateRandomJMBG(), UserType.values()[random.nextInt(UserType.values().length)], random.nextLong(1, 18)),
