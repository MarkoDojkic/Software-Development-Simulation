...
public class DataProvider {
	...
	public static void setupDataProvider(boolean isTest){
		...
		setTechnicalManager(new Developer(getLorem().getNameFemale(), generateRandomYugoslavianUMCN(true, isTest), DeveloperType.TECHNICAL_MANAGER, true, getRandom().nextLong(5, 18)));
	}
