...
public class JiraActivityStream {
	...
	public Epic printInProgressEpic(Epic epic){
		Utilities.getIPrinter().sendToJiraActivityStream(String.format("\033[1m%s\033[21m\033[24m changed the Assignee to '\033[1m%s\033[21m\033[24m' on \033[3m\033[1mEPIC-%s\033[21m\033[24m - %s\033[23m ◴ %s$",
		...
		Utilities.getIPrinter().sendToJiraActivityStream(String.format("\033[1m%s\033[21m\033[24m changed the status to In progress on \033[3m\033[1mEPIC-%s\033[21m\033[24m - %s\033[23m ◴ %s$", 
	...
	public List<UserStory> printInProgressEpic(List<UserStory> userStoryList){
		...
		Utilities.getIPrinter().sendToJiraActivityStream(String.format("\033[1m%s\033[21m\033[24m started sprint for \033[3m\033[1mEPIC-%s\033[21m\033[24m \033[23m ◴ %s$",
	...
	public TechnicalTask printToDoTechnicalTask(TechnicalTask technicalTask){
		...
		Utilities.getIPrinter().sendToJiraActivityStream(String.format("\033[1m%s\033[21m\033[24m created \033[3m\033[1mTASK-%s\033[21m\033[24m - %s\033[23m ◴ %s$",
		...
		Utilities.getIPrinter().sendToJiraActivityStream(String.format("\033[1m%s\033[21m\033[24m changed the Assignee to '\033[1m%s\033[21m\033[24m' on \033[3m\033[1mTASK-%s\033[21m\033[24m - %s\033[23m ◴ %s$",
